...
export function calculateFlowRoof(input={},systemVariant=''){
 ...
 const snow={...snowRaw,designPa:snowRaw.snowPa},wind={...windRaw,edgePa:windRaw.perZonePa.roofEdge_panelEdge,middlePa:windRaw.perZonePa.roofMid_panelMid},loads={snow,wind};
 if(systemVariant===Object.keys(FLOW_BRANCHES)[2])return{branch,loads,blockedCode:'south'};
 return{branch,loads,orientation};
}
