...
export default function StringMarkingTabV7({ project, onUpdate }) {
  ...
  const buildPayload = (nextStrings = strings, overrides = {}) => ({ version: 59, source: 'properties_only_no_duplicate_inverter', stringCount: overrides.stringCount ?? countValue, settings: overrides.settings ?? settings, strings: cleanStrings(nextStrings), savedAt: new Date().toISOString() });
