...
export default function StringMarkingTabV7({ project, onUpdate }) {
  ...
  const buildPayload = (nextStrings = strings, overrides = {}) => ({ version: 57, source: 'cad_zoom_readable_exact_paneler_geometry', stringCount: overrides.stringCount ?? countValue, settings: overrides.settings ?? settings, strings: cleanStrings(nextStrings), savedAt: new Date().toISOString() });
