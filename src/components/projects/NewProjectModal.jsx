...
export default function NewProjectModal({ onSave, onClose }) {
  const [form, setForm] = useState({ name: '', customer_name: '', address: '', status: 'planering' });
      ...
      <div className="bg-card rounded-2xl border border-border w-full max-w-md">
        ...
        <div className="p-5 space-y-4">
          ...
          <div>
            ...
            <input
              ...
              placeholder="T.ex. Solgatan 12, Stockholm"
              className="w-full border border-border rounded-xl px-3 py-2 text-sm bg-background focus:outline-none focus:ring-2 focus:ring-primary/30"
            />
          </div>
          <div>
        ...
        <div className="flex gap-3 p-5 border-t border-border">
          ...
          <button
            ...
            className="flex-1 py-2.5 rounded-xl bg-primary text-white text-sm font-medium hover:bg-primary/90 disabled:opacity-50 flex items-center justify-center gap-2"
          >
